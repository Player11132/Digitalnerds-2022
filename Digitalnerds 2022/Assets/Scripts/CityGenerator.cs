...
using UnityEngine;
//Modified Version of Simple City Generator by Art Notes
[ExecuteInEditMode]
public class CityGenerator : MonoBehaviour
{
    public int CityZoneCount = 200, BigSectorCount = 500, SqareLength = 20;
    public Vector3Int CityCentre;
    public CitySample[] List1x1, List1x2, ListAngle;
    public List<CitySample> Placed = new List<CitySample>();
    ...
    public int SelectPrefab(CitySample[] List)
    {
        int VeritySumm = 0;
